...
/**
 * Implementation of a [RecyclerView] used by the webtoon reader. Ported verbatim from yomi: handles
 * the whole-strip pinch/double-tap zoom (the recycler itself is scaled and its touch events are
 * translated by [WebtoonFrame]) and reports single taps / long taps back to the viewer.
 */
