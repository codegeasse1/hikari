...
/**
 * Layout manager used by the webtoon viewer (ported verbatim from yomi). Item prefetch is disabled
 * because the extra layout space feature is used which allows setting the image even if the holder
 * is not visible, avoiding (in most cases) black views when they are visible.
 *
